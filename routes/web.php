...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/role/getmodaleditrole', [RoleMainController::class, 'getmodaleditrole'])->name('role.getmodaleditrole');
    Route::post('/role/updaterole', [RoleMainController::class, 'update'])->name('role.updaterole');
    // pengguna
